...
export type InstructionsDiagnosticsParams = SchemaType<"InstructionsDiagnosticsParams">;
export type InstructionsDiagnosticsResult = SchemaType<"InstructionsDiagnosticsResult">;
