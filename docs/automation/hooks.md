...
- Only recognized bootstrap basenames are loaded (`AGENTS.md`, `CLAUDE.md`, `CLAUDE.local.md`, `SOUL.md`, `TOOLS.md`, `IDENTITY.md`, `USER.md`, `HEARTBEAT.md`, `BOOTSTRAP.md`, `MEMORY.md`, `memory.md`).
- For subagent/cron sessions a narrower allowlist applies (`AGENTS.md`, `CLAUDE.md`, `CLAUDE.local.md`, `TOOLS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`).
